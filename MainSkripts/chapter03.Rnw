...
<<'simdata.LMG.plot', cache=TRUE, echo=FALSE, fig.cap='LMG distributions of the predictors.'>>=
pairs.chart
@
...
<<'empi.lmg.plot', echo = FALSE, fig.cap='LMG distributions of the different verbal ability predictors.'>>=
#Visualization
dat <- data.frame(t(LMG.Vals.I))
